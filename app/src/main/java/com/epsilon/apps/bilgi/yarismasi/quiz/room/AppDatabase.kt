...
import com.epsilon.apps.bilgi.yarismasi.quiz.room.dao.ActiveQuizQuestionsDao
...
@Database(
    ...
    entities = [
        ...
        User::class,
        UserProgress::class,
        ActiveQuizQuestion::class
    ]
)
abstract class AppDatabase : RoomDatabase() {
    abstract fun accessQuestions(): QuestionsDao
    abstract fun accessActiveQuizQuestions(): ActiveQuizQuestionsDao
